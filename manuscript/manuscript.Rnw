...
placenta.lineage.specific.table <- function(analysis,output=TRUE,lineage.table=placenta.lineage.specific.analysis,members=5,orderbyfc=FALSE,fdr.cutoff=1) {
    ...
    if (output) {
        ...
        print(xtable(display.table,
                     display=c("s","s","e","e","f"),
                     align=c("c","p{0.5in}","S[table-format=1.2e2]","S[table-format=1.2e2]","S[table-format=2.2]")
                     ),
              booktabs=TRUE,
              floating=FALSE,
...
@ 
\caption{\lineagetableexplanationtypeiiishort{\human}{all other analyzed species}}
