...
also associated with adverse pregnancy outcomes. Comparisons between
rodentia (\mouse, \galili, and \carmeli) and all other species using
the mean of each species expression did not indicate any significant
differences (Supplemental \cref{tab:rodentia_lineage_specific}) nor
did the equivalent comparisons between laurasiatheria and all other
species (Supplemental \cref{tab:laurasiatheria_lineage_specific}) and
laurasiatheria and euarchontoglires (Supplemental
