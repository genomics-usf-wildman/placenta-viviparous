...
The top 50 expressed genes as measured by \ac{FPKM} in the term
placenta of the \bonobo are shown in \cref{tab:top50_bonobo_placenta}
...
expressed at high levels (\ac{FPKM}=1232.56; \cref{tab:top50_bonobo_placenta}). Two other Pan genes
...
\cref{tab:all_pan_paniscus_placenta}). Placental expression of the genes involved in estrogen and
