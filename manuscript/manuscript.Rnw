...
Another annexin which is highly expressed in the core placenta is
\textit{ANXA5}, a gene which was originally identified as
...
Tlr9 immune response in mice\DLA{cite TLR7/TLR9 paper}, and
