...
Afrotheria, and Xenartha, \cref{fig:species_tree})
has evolved expansive placenta-specific gene
...
\elephant, and the expansion of the growth hormone and
...
32, roughly one day prior to birth. Only the fetal villous portion of
...
from the fetal villous portion by dissection, and the
resulting fetal villous portion was washed twice in PBS. All tissues
...
species using biomaRt package and Ensembl v.80 database to determine
the percentage of highly expressed genes which had an orthology of
...
the fetal interface, they likely include substantial cell and tissue
...
for cell-cell and cell-matrix interactions, such as \ac{LGALS1}. These
