...
(\ac{FPKM}=\Sexpr{gene.expression(species.name="homo sapiens",gene="PSG10P")}, \cref{fig:psg_evolution_tree}) . %
These
...
(\ac{FPKM}=\Sexpr{gene.expression("homo sapiens","PRG2")};
...
(\ac{FPKM}=\Sexpr{gene.expression("pan paniscus","CGA")}), but at much
...
(\ac{FPKM}=\Sexpr{gene.expression("ateles fusciceps","PAGE4")}), %
the pregnancy specific glycoprotein \textit{PSG8}
(\ac{FPKM}=\Sexpr{gene.expression("ateles fusciceps","PSG8")}), %
a member of the chorionic somatotropins, \textit{GH1} %
(\ac{FPKM}=\Sexpr{gene.expression("ateles fusciceps","GH1")}), %
