...
(\ac{FPKM}=\Sexpr{gene.expression("canis familiaris","LGALS1")}). %
In addition, an ortholog of SSLP1 (ENSCAFG00000010638) a gene
expressed in the placentas of \cow (%
\Sexpr{gene.expression("bos tarus","SSLP1")}, %
\cref{tab:top50_cow_placenta}) and \sheep
(\Sexpr{gene.expression("ovis aries","SSLP1")},
...
%
(\ac{FPKM}=\Sexpr{gene.expression("canis familiaris","ENSCAFG00000010638")}). %
There is no placental expression of the estrogen synthase gene
(\textit{CYP19A1}) in \dog (\cref{fig:estrogen_evolution_tree}), 
however expression of \textit{HSD3B1} is relatively high
(\ac{FPKM}=\Sexpr{gene.expression("canis familiaris","HSD3B1")}).
