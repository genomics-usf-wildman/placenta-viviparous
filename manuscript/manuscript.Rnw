...
\begin{table}
  \begin{tabular}{c c c p{3in}}
    ...
    \textit{Dasypus novemcinctus} & 135 & 4 & \DLA{Cite Amazing Armadillo: geography book}\\
...
@ 
\caption{\tableexplanation{\smonkey}{tab:all_ateles_fuciceps_placenta}}
...
(\Sexpr{gene.expression("ateles fusciceps","PAGE4")}), %
the pregnancy specific glycoprotein \textit{PSG8}
(\Sexpr{gene.expression("ateles fusciceps","PSG8")}), %
a member of the chorionic somatotropins, \textit{GH1} %
(\Sexpr{gene.expression("ateles fusciceps","GH1")}), %
a few HLA genes (\textit{HLA-A}, \textit{HLA-F},
\cref{tab:top50_spider_monkey_placenta}), and multiple components of
the annexin complex %
(\Sexpr{gene.expression("ateles fusciceps","ANXA2",complete=TRUE)}, %
\Sexpr{gene.expression("ateles fusciceps","S100P",complete=TRUE)}, %
\Sexpr{gene.expression("ateles fusciceps","S100A11",complete=TRUE)}) %
which may play a role in angiogenesis, and certainly regulate
cell-cell interaction in the developing placenta
\cite{Liu.ea2015:AnnexinA2complexeswith}. All genes with expression
greater than 50 \ac{FPKM} are listed in Supplementary
\cref{tab:all_ateles_fuciceps_placenta}.
...
plot.tree.matrix(read.tree(text=trees[[tree.id]]$tree.dat),gene.tree.table,gene.tree.expression)
@ 
\caption{\genetreeexplanation{estrogen sythesis genes}}
...
plot.tree.matrix(read.tree(text=trees[[tree.id]]$tree.dat),gene.tree.table,gene.tree.expression)
@ 
\caption{\genetreeexplanation{progesterone sythesis genes}}
