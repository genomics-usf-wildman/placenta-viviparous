...
pp <- ggtree(species.tree)+
    geom_text(aes(label=gsub("_"," ",label)),vjust=0.65,hjust=0,size=4,fontface="italic")+
    geom_text(data=data.frame(x=1,y=1),label="Metatheria",hjust=0,vjust=0,size=4,fontface="italic")+
