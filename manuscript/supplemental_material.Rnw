...
\begin{table}[hb]
<<placental_classification,echo=FALSE,results="asis">>=
placental.classification <- fread("../data/placental_classification.txt")
...
print(xtable(go.analysis.wide.table,
             ...
             align=  c("c","c","c","c","c","c"),
             caption="GO terms with significant enrichment ($\\text{FDR}\\le0.05$)
