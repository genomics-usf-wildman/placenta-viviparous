...
significantly associated with the shape of placenta attachment, as
...
attachment include \textit{EREG}, a ligand of EGFR, \textit{UNC93A}, a
homolog of \textit{UNC93B1} which is involved in the balancing between
