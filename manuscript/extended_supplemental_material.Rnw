...
opts_chunk$set(cache=TRUE, autodep=TRUE,cache.path="extended_supplemental_cache/")
opts_chunk$set(fig.path="extended_supplemental_figure/")
...
print(xtable(placenta_classification,
             display=c("s","s","s","s","s"),
             align=c("c","c","c","c","c")),
...
for (this.species in names(species.names)) {
    ...
    cat(paste0("\\subsubsection{\\textit{",capfirst(this.species),"} Placental Gene Expression}\n\n"))
...
@ 
\caption{Top 50 genes which are associated with the shape of placenta attachment}
...
@ 
\caption{Top 50 genes which are associated with the degree of placenta intimacy}
...
@ 
\caption{Top 50 genes which are associated with the degree of placenta intimacy; ordered analysis}
...
@ 
\caption{Top 50 genes which are associated with the degree of maternal-fetal interdigitation}
...
@ 
\caption{Top 50 genes which are associated with the degree of maternal-fetal interdigitation; ordered analysis}
...
@ 
\caption{\genetreeexplanation{\textit{CRH}}}
...
@ 
\caption{\genetreeexplanation{\textit{ADAM12}}}
...
@ 
\caption{\genetreeexplanation[0.1]{\textit{KISS1}}}
...
@ 
\caption{\genetreeexplanation[0.1]{\textit{PAPPA}}}
\label{fig:pappa_evolution_tree}
\end{figure}

\begin{figure}
<<tgfb1.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="TGFB1"
                                                    & species=="homo sapiens"),
                                subtree=c("ENSMODG00000008630","ENSSSCG00000026296"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.3))
@ 
\caption{\genetreeexplanation{\textit{TGFB1}}}
\label{fig:tgfb1_evolution_tree}
\end{figure}


\begin{figure}
<<gpc3.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="GPC3"
                                                    & species=="homo sapiens"),
                                subtree=c("ENSCAFG00000018864","ENSLAFG00000025706"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.13))
@ 
\caption{\genetreeexplanation{\textit{GPC3}}}
\label{fig:gpc3_evolution_tree}
\end{figure}

\clearpage

\subsection{Primate Specific Evolution}

\begin{figure}[hbf]
<<fstl1.evolution.tree,echo=FALSE,out.height="0.6\\textheight",fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="FSTL1"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=5,color="black",fontface="italic")+xlim(0,3))
@ 
...
\subsection{Other Gene Trees}

\begin{figure}[hbf]
<<serpine.evolution.tree,echo=FALSE,out.height="0.6\\textheight",fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="SERPINE2"
                                                    & species=="homo sapiens"),
                                subtree=c("ENSBTAG00000008717",
                                          "ENSMODG00000004913"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=4,color="black",fontface="italic")+xlim(0,0.8))
@ 
...
\begin{figure}
<<sslp1.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_id=="ENSCAFG00000010638" &
                                                    species=="canis familiaris"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,1.2))
@ 
...
\begin{figure}
<<estrogen.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="CYP19A1"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
...
\begin{figure}
<<progesterone.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="HSD3B1"
                                                    & species=="homo sapiens"),
      ...
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.6))
@ 
...
\begin{figure}
<<chorionic.somatomammotropin.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="CSH1"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.9))
@ 
...
print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="PRL"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=3,color="black",fontface="italic")+xlim(0,1))
@ 
...
\begin{figure}
<<rln2.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="RLN2"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.8))
@ 
...
\begin{figure}
<<ovos2.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=



print(plot.ancestral.state.tree(gene_selector=quote(gene_id=="ENSDNOG00000033320"),
                                subtree=c("ENSDNOG00000033320","ENSMODG00000017988"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=5,color="black",fontface="italic")+xlim(0,1.3))
@ 
...
\begin{figure}
<<prolactin.receptor.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="PRLR"
                                                    & species=="homo sapiens"),
...
\begin{figure}
<<cgb2.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="CGB2"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic"))
@ 
\caption{\genetreeexplanation{\textit{CGB2}}}
\label{fig:cgb2_evolution_tree}
\end{figure}


\begin{figure}
<<hoxa11.receptor.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="HOXA11"
                                                    & species=="homo sapiens"),
      ...
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.4))
@ 
...
\begin{figure}
<<hbe1.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="HBE1"
                                                    & species=="homo sapiens"),
                                subtree=c("ENSBTAG00000037815",
                                          "ENSMUSG00000078621"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=4,color="black",fontface="italic")+xlim(0,0.6))
@ 
\caption{\genetreeexplanation{\textit{HBE1}}}
\label{fig:hbe1_evolution_tree}
\end{figure}

\begin{figure}
<<nppb.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="NPPB"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
...
\begin{figure}
<<nppc.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="NPPC"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,0.32))
@ 
...
\begin{figure}
<<galectins.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="LGALS1"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,1))
@ 
\caption{\genetreeexplanation{\textit{LGALS1} and \textit{LGALS2}}}
\label{fig:galectins_evolution_tree}
\end{figure}


\begin{figure}
<<lgals13.galectins.evolution.tree,echo=FALSE,fig.width=8,fig.height=8,warning=FALSE,message=FALSE>>=

print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="LGALS13"
                                                    & species=="homo sapiens"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees
                                )+
      geom_tiplab(size=6,color="black",fontface="italic")+xlim(0,1.5))
@ 
...
@ 
\caption{\lineagetableexplanation{the rodentia order}{all other species}}
...
@ 
\caption{\lineagetableexplanation{the laurasiatheria
    superorder}{all other species}}
...
@ 
\caption{\lineagetableexplanation{ the euarchontoglires superorder}{ the laurasiatherian superorder}}
\label{tab:laurasiatheria_euarchontoglires_lineage_specific}
\end{table}
...
@ 
\caption{GO terms most significantly enriched
...
print(ggplot(cpt.distribution.shape[`Expression (FPKM)` > 0.1,],
             aes(x=`Expression (FPKM)`,color=`Minimum Expression in`,y=num_genes))
      + geom_line(lwd=1)
      + xlab("Minimum Expression cutoff (FPKM)")
      + ylab("Genes with N-th Minimum Expression")
      ...
      + geom_segment(mapping=aes(y=V1,
                         ...
                         xend=10,
                         x=1000,
                         color=`Minimum Expression in`),
                     data=cpt.distribution.shape[`Expression (FPKM)` > 10,
                                              max(num_genes),`Minimum Expression in`],
                     arrow=arrow(length=unit(0.5,"cm"))
                   )
      + geom_text(mapping=aes(x=1000,
                      y=V1,
      ...
      + guides(color=guide_legend(title="Minimum\nExpression in"))
      )
@ 
\caption{Distribution shape of placenta core genes. The vertical axis
  ...
  \Sexpr{cpt.distribution.shape[,levels(`Minimum Expression in`)[1]]}
  %
  (or %
  \Sexpr{cpt.distribution.shape[,levels(`Minimum Expression in`)[2]]},
  % 
  ...
  least 10, %
  \Sexpr{cpt.distribution.shape[`Expression (FPKM)` > 10 
    & `Minimum Expression in` == "13 of 14 species",max(num_genes)]}
  %
  1:1 orthologs would be included if 13 of 14 species have an
   with an FPKM of at least 10, and 
  \Sexpr{cpt.distribution.shape[`Expression (FPKM)` > 10 
    & `Minimum Expression in` == '10 of 14 species',max(num_genes)]}
...
\begin{figure}
<<housekeeping.placenta.distribution,fig.width=8,fig.height=8,out.height="0.8\\textheight",echo=FALSE,message=FALSE>>=
...
cpt.h.distribution.shape <- 
    cpt.h.distribution.shape[,`Minimum Expression in`:=
                                fix.expression.names(`Minimum Expression in`)]
...
@ 
\caption{Distribution shape of housekeeping genes in placentas out of
  ...
  \Sexpr{cpt.h.distribution.shape[,levels(`Minimum Expression in`)[1]]}
  %
  (or %
  \Sexpr{cpt.h.distribution.shape[,levels(`Minimum Expression in`)[2]]},
  % 
  etc.) have a minimum expression in FPKM equal to the horizontal axis.
  For example, if the cutoff is set to 10 (vertical black line), 
  % 
