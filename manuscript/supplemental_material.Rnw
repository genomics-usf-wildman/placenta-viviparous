...
opts_chunk$set(dev="cairo_pdf",out.width="\\textwidth",out.height="0.65\\textheight",out.extra="keepaspectratio")
...
\begin{table}
  \raggedright
  \begin{tabular}{c >{\raggedright}p{1.5in} c >{\raggedright\arraybackslash}p{2in}}
    \toprule
    Species                       & Collector & Experiment & Sample(s) \\
    \midrule
    \textit{Ateles fusciceps}     & Kurt Benirschke & GSE79121 & SRX1629201 \\
    \textit{Bos taurus}           & Bob Kreft & GSE79121 & SRX1629203 \\
    \textit{Canis familiaris}     & Dalen Agnew & GSE79121 & SRX1629204 \\
    \textit{Dasypus novemcinctus} & Richard Truman, Vincent J. Lynch& GSE79121 & SRX1629200 \\
    \textit{Equus caballus}       & \citet{Coleman.ea2010:Structuralannotationofequine} & GSM1139275 & SRR850299,  SRR850300 \\
    \textit{Loxodonta africana}   & Kurt Benirschke & GSE79121 & SRX1629205 \\
    \textit{Homo sapiens}         & \citet{Hughes.ea2015:Evaluatingintra-andinter-individual} & GSE66622 
                                             & SRR1850945,
                                               ...
                                               SRR1851011, 
                                               SRR1851012 \\
    \textit{Monodelphis domestica} & Karen Smith, Gunter Wagner & GSE79121 & SRX1629207 \\
    \textit{Mus musculus}         & \citet{Wang.ea2011:surveyfornovelimprinted} & GSE29690 
                                     & SRR243594, 
                                       ...
                                       SRR243592, 
                                       SRR243593\\
    \textit{Ovis aries}           & \citet{Archibald.ea2010:sheepgenomereferencesequence} & ERP005642 & ERR489144, ERR489145\\
    \textit{Pan paniscus}         & William Mintz Fields & GSE79121 & SRX1629202 \\
    \textit{Spalax carmeli}       & Anne Dupressoir, Eviator Nevo & GSE68763 & SRR2016467 \\
    \textit{Spalax galili}        & Eviator Nevo                  & GSE68763 & SRR2016466 \\
    \textit{Sus scrofa}           & \citet{Ahanda.ea2012:Predictionofaltered3-} &  SRP014902 & SRR543893 \\
    \bottomrule
  \end{tabular}
...
for (this.species in names(species.names)) {
    cat(paste0("\\subsubsection{Significantly enriched ($\\mathrm{FDR}\\le0.05$) GO terms in ",
                           " the top 100 \\textit{",
                           capfirst(this.species),"} expressed transcripts}\n\n"))
    this.caption <- paste0("Significantly enriched ($\\mathrm{FDR}\\le0.05$) GO terms in ",
...
\subsubsection{Pre-eclampsia genes}
...
\subsubsection{Primate Specific Evolution}
...
hum.all.lin.spec <- placenta.lineage.specific.table("hum.all")
setkey(hum.all.lin.spec,"Human Symbol")
@ 
\caption{Genes whose expression changed in \human
...
@ 
\caption{Genes whose expression changed in the Rodentia
...
\caption{Genes whose expression changed between the
  Euarchontoglires and Laurasiatherian superorder.}
...
\caption{GO terms most significantly enriched
  ...
  number of genes in the core transcriptome for each GO term;
