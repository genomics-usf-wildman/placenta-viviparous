...
<<load_core_placenta_tree_transcriptome,echo=FALSE,results="hide",cache.extra=file.info("../data/placenta_core_tree_transcriptome")[,"mtime"]>>=
...
include nearly all of the genes present in the core placenta
transcriptome (Supplemental
