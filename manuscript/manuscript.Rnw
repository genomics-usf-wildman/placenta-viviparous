...
genes in Supplemental \cref{tab:all_mouse_placenta}.
...
genes in Supplemental \cref{tab:all_s_carmeli_placenta}.
...
genes in Supplemental \cref{tab:all_horse_placenta}.
...
genes in Supplemental \cref{tab:all_sheep_placenta}.
