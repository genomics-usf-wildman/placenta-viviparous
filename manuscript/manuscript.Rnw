...
\begin{table}
  \begin{tabular}{c c c c}
    ...
    \midrule
    \textit{Ateles fusciceps}     & 224 & 1 & \cite{Ernest2003:lifehistorycharacteristicsofplacental}\\
    ...
    \textit{Loxodonta africana}   & 644 & 1 & \cite{Ernest2003:lifehistorycharacteristicsofplacental}\\
    ...
    \textit{Pan paniscus}         & 223 & 1 & \cite{Ernest2003:lifehistorycharacteristicsofplacental} \\
