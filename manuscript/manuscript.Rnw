...
\cref{tab:all_loxodonta_africana_placenta}. The gene with the
highest expression was the natriuretic peptide precursor B
(\Sexpr{gene.expression("loxodonta africana","NPPB",complete=TRUE)}).
Two thymosins, %
\Sexpr{gene.expression("loxodonta africana","TMSB10",complete=TRUE)} %
and %
\Sexpr{gene.expression("loxodonta africana","TMSB4Y",complete=TRUE)}
were also also was highly expressed. The miRNA mir-675
(\Sexpr{gene.expression("loxodonta
  africana","ENSLAFG00000027406",complete=TRUE)}). which is imbedded
in the first exon of the maternally imprinted long non-coding RNA gene
\textit{H19} \cite{Keniry.ea2012:H19lincRNAisdevelopmental}, a gene
which is currently un-annotated in \elephant{}. %
\DLA{Probably consider fixing the unannotation of H19; it seems pretty
  ...
  \href{http://useast.ensembl.org/Loxodonta_africana/Transcript/Summary?db=core;pt=GENSCAN00000034833;r=scaffold_145:855987-899506}{genscan prediction} for this region}
...
which %
%
(\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000028493",complete=TRUE)},
\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000032011",complete=TRUE)},
\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000031933",complete=TRUE)}) %
%
...
(\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000026505",complete=TRUE)}). %
%
Two other novel genes with high expression are related to the gene
\textit{SSLP1} %
%
(\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000032659",complete=TRUE)} %
and %
%
\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000029551",complete=TRUE)},
%
...
\Sexpr{gene.expression("loxodonta africana","ENSLAFG00000036090")})
...
\textit{CYP19A1} %
(\Sexpr{gene.expression("loxodonta africana","CYP19A1")}) and the
enzyme that produces progesterone HSD3B1 %
(\Sexpr{gene.expression("loxodonta africana","HSD3B")}). Other genes
with high expression in the elephant placenta include genes involved
in oxidative stress %
(\Sexpr{gene.expression("loxodonta africana","TXN",complete=TRUE)}),
growth %
(\Sexpr{gene.expression("loxodonta africana","IGF2",complete=TRUE)})
and %
\Sexpr{gene.expression("loxodonta africana","PAEP",complete=TRUE)}, %
a gene usually expressed in the endometrium of the uterus in humans
