...
in which the difference is most significant.

\textit{EREG} -- ligand of EGFR, known to be expressed in some
placentas but apparently not present in the term placentas of \human.

\textit{UNC} -- totally unknown
