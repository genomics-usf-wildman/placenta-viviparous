...
inhibition of GSN and HSPC300. Other compoenents of cell-cell
...
The high level of expression of components of the EGFR signaling
pathway in the core placenta transcriptome (including \textit{GRB2}, \textit{EGFR}, \textit{MAPK3}, \textit{MAP2K2}, \textit{SHC1}, \textit{AKT3}, \textit{AKT2}, \textit{ERBB3}

% Role of CD9 in invasion; commonality between placentas
