...
\fref{tab:top50_human_placenta} with a list of all genes in
...
in humans is \ac{CSH1}, followed by \ac{CSH2}, and \ac{CSHL1}, all
three of which are members of a distinct expansion of the growth
hormone gene family within hominoids. Another member of the growth
...
% 
Ten pregnancy-specific beta-1-glycoprotein genes are highly-expressed
(\ac{FPKM}>100) in the term placenta of humans, with \ac{PSG4} showing the
greatest degree of expression %
(\ac{FPKM}=\Sexpr{gene.expression(species.name="homo sapiens",gene="PSG4")}). % 
These
genes are members of a hominoid-specific expansion of the
...
(\ac{FPKM} = 4817.15 and 829.846 respectively), as well as CGA
(\ac{FPKM}= 4793.08), which generates the alpha subnit of multiple
human chorionic gonadotropin hormones (Table 2). The genes producing
the beta subunits of the chorionic gonadotropins (CGB, CGB1, CGB2,
CGB5, CGB7, CGB8) are either not expressed (CGB8) or expressed
modestly (FPKM≤20.826; Table 8). Other highly expressed genes in the
top 50 include members of the hemoglobin family (e.g. HBA1, HBB, HBG2,
HBA2), the maternally imprinted long noncoding RNA gene H19, genes
coding for proteins required for growth and/or cell proliferation
(ADAM12, KISS1, IGF2, GPC3, CSF3R), anticoagulation (TFPI2), and
glucose transport (SLC2A1) among others (Table 2, Supplemental Table
X)
...
the bonobo are shown in \fref{tab:top50_bonobo_placenta} with a list of all genes in
...
50 genes (Table 3). The highest expression (\ac{FPKM}=%
\Sexpr{gene.expression("pan paniscus","PRG2")}%
%
) in bonobo is \ac{PRG2}, which is involved in insulin
growth factor signaling and angiogenesis during pregnancy \cite{Weyer.ea2011:Placentalregulationofpeptide}. \ac{PRG2} is also expressed at relatively high levels in the
human placenta (\ac{FPKM}=\Sexpr{gene.expression("homo sapiens","PRG2")}; Supplemental Table X), although at
