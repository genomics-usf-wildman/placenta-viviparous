...
\begin{figure}[hb]
<<adam12.evolution.tree,echo=FALSE,out.height="0.6\\textheight",fig.width=12,fig.height=12,warning=FALSE,message=FALSE>>=
...
plot.tree.matrix(read.tree(text=trees[[tree.id]]$tree.dat),
                 gene.tree.table,gene.tree.expression,min.fpkm=5,
                 axis.text.size=5,
                 fontsize=8
                 )
@ 
...
@ 
\caption{\genetreeexplanation{\textit{KISS1}}}
...
@ 
\caption{\genetreeexplanation{\textit{PAPPA}}}
...
\begin{figure}
<<gpc3.evolution.tree,echo=FALSE,fig.width=12,fig.height=12,warning=FALSE,message=FALSE>>=
