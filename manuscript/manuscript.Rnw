...
@ 
\caption{Expression of follistatin-like 1 \textit{FSTLl1} and related
  genes.}
...
@ 
\caption{Expression in \ac{FPKM} of top 50 genes in \smonkey which are not ribosomal, 
mitochondrial, or whose human ortholog is a housekeeping gene}
...
@ 
\caption{Expression in \ac{FPKM} of the top 50 genes in \dog which are
  not ribosomal, mitochondrial, or whose human ortholog is a
  housekeeping gene}
...
@ 
\caption{Expression of genes related to \cow \textit{PAG2} with $\mathrm{FPKM} \ge 1$}
...
plot.tree.matrix(read.tree(text=trees[[tree.id]]$tree.dat),gene.tree.table,gene.tree.expression)
@ 
\caption{Expression of \textit{RLN2} and related genes}
...
@ 
\caption{Expression of \textit{OVOS2} and related genes}
...
plot.tree.matrix(read.tree(text=trees[[tree.id]]$tree.dat),gene.tree.table,gene.tree.expression)
@ 
\caption{Expression of \textit{TMSB1}}
