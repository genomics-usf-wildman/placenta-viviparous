...
\begin{figure}
<<core.placenta.transcriptome,fig.width=7,fig.height=7*9/16,out.height="0.8\\textheight",echo=FALSE>>=
cptl <-
...
cptl[,human_name:=factor(human_name,rev(levels(as.factor(human_name))))]
...
print(ggplot(cptl[FPKM > 0.1,],aes(x=human_name,y=FPKM))+
      ...
      theme(text=element_text(size=9),
            ...
            axis.text.x=element_text(face="italic",size=7,angle=90,hjust=1,vjust=0.5),
