...
\caption{\lineagetableexplanationtypeiiishort{\human}{all other
    analyzed species} Adv. Preg. Pub. is the approximate number of
  publications indexed by PubMed mentioning this gene and an adverse
  pregnancy outcome (pre-eclampsia, premature labor, gestational
  diabetes, intrauterine growth restriction, or premature birth) and
  links to the most current PubMed search results.}
