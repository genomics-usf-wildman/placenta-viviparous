...
from the fetal villous portion using forceps and a scapel, and the
...
%
Between 20\% and 40\% of all highly expressed genes in each species
...
common mammalian ancestor included in this study. We hypothesize that
modifications to their expression or function will compromise the
