...
combined.fpkm <- genes.to.tree[combined.fpkm[!is.na(gene_id),]]
...
core.placenta.tree.transcriptome.long[tree %in% 
                                      genes.to.tree[housekeeping.genes.superset[,as.character(tracking_id)],
                                                    tree],
                                      housekeeping:=TRUE]
core.placenta.tree.transcriptome.long[,tree:=
                                           reorder(tree,
                                                   combined.fpkm.wide[!is.na(tree_genes),
