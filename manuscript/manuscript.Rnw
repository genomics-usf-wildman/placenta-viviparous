...
\begin{table}
  \begin{tabular}{c c c c}
    ...
    \textit{Bos taurus}           & Cow                & UMD3.1     & 76 \\
    \textit{Canis familiaris}     & Dog                & CanFam3.1  & 151 \\
    \textit{Dasypus novemcinctus} & 9-Banded Armadillo & DASNOV3    & 101 \\
    \textit{Loxodonta africana}   & Elephant           & loxAfr3    & 76 \\
    \textit{Homo sapiens}         & Human              & GRCh38     & 76, 151 \\
    \textit{Monodelphis domestica} & Opossum           & BROAD05    & 76 \\
    \textit{Mus musculus}         & Mouse              & GRCm38     & 36,44,151 \\
    \textit{Nannospalax galili}   & Blind mole rat     & \textit{Mus musculus} & 100 \\
    \textit{Pan paniscus}         & Bonobo             & CHIMP2.1.4 & 151 \\
