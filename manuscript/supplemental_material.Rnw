...
hum.all.lin.spec <-
    placenta.lineage.specific.table("hum.all",
                                    ...
                                    members=NA,
                                    caption="\\lineagetableexplanationtypeiii{\\human}{all other species}",
                                    label="tab:huamn_linage_specific_all"
                                    )
...
@ 
\caption{\lineagetableexplanationtypeiii{the rodentia order}{all other species}}
...
\begin{figure}[tbh]
<<core.placenta.transcriptome.housekeeping,fig.width=5,fig.height=10,out.height="0.8\\textheight",echo=FALSE>>=
cptlh <-
...
print(ggplot(cptlh,aes(x=human_name,y=FPKM))+
