...
\begin{frame}{Core Placenta Transcriptome Shape}
\begin{figure}
<<core.placenta.transcriptome.distribution,fig.width=6,fig.height=4,out.height="0.8\\textheight",echo=FALSE,message=FALSE>>=
...
\begin{frame}{EGFR}
  \begin{figure}
<<egfr_expression,echo=FALSE,fig.width=5,fig.height=5>>=
print(plot.ancestral.state.tree(gene_selector=quote(gene_short_name=="EGFR" &
                                                    species=="homo sapiens"),
                                subtree=c("ENSG00000146648","ENSMODG00000009033"),
                                genes.to.tree=genes.to.tree,
                                combined.fpkm=combined.fpkm,
                                trees=trees,
                                tree.line.width=2
                                )+
      geom_tiplab(size=5,color="black",fontface="italic")+xlim(0,0.4))
